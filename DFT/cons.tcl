...
set_input_delay $dft_in_delay -clock SCAN_CLK [get_port SI]
set_input_delay $dft_in_delay -clock SCAN_CLK [get_port SE]
set_input_delay $dft_in_delay -clock SCAN_CLK [get_port test_mode]
...
set_output_delay $dft_out_delay -clock SCAN_CLK [get_port SO]
